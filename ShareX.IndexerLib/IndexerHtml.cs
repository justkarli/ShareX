...
namespace ShareX.IndexerLib
{
    public class IndexerHtml : Indexer
    {
        ...
        protected override string GetFolderNameRow(DirectoryFileInfo directory_info, int level)
        {
        ...
        {
            return string.Format("Generated by {0} on {1}.", string.Format("<a href=\"{0}\">{1}</a>", Links.URL_WEBSITE, "ShareX " + Application.ProductVersion), DateTime.UtcNow.ToString(DATE_FORMAT));
        }
    }
}